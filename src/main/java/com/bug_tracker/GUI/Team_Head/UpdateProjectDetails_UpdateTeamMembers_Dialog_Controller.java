...
public class UpdateProjectDetails_UpdateTeamMembers_Dialog_Controller implements Initializable {
    ...
    public ObservableList<Employee> getAllTeamMembersList() {
        return this.allTeamMembersList;
    }

    public void setAllTeamMembersList(ObservableList<Employee> allTeamMembersList) {

        for(Employee emp :allTeamMembersList)
        {
            this.allTeamMembersList.add(emp);
        }

        //Updating the table view of the all team members working on a project
        TeamMembers_TableView.setItems(this.allTeamMembersList);
    }
    ...
    void insertSelectedDeveloper(ActionEvent event) {
        ...
        {
            if(iteratorDeveloper.getUserName() == selectedDeveloper.getUserName())
    ...
    void insertSelectedTester(ActionEvent event) {
        ...
        {
            if(iteratorTester.getUserName() == selectedTester.getUserName())
                insertDeveloperFlag=false;

        }
        if(insertDeveloperFlag==true)
        {
            this.allTeamMembersList.add(selectedTester);
            TeamMembers_TableView.setItems(allTeamMembersList);
        }
        else
        {
    ...
    void performRemoveTeamMember(ActionEvent event) {
        ...
        {
            if(iteratorTeamHead.getEmail() == selectedTeamMember.getEmail())
            {
