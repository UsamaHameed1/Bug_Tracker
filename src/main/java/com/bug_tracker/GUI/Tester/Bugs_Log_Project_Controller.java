...
public class Bugs_Log_Project_Controller implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        workingProjectDetails.setAll(Tester_MainScreen_Controller.getCurrentTesterObject().getAllWorkingProjects());
    ...
    void performSeeBugLogOfProject(ActionEvent event) throws IOException {
        ...
        fxmlLoader.setLocation(main.class.getResource("Tester_Bug_Log_Dialog.fxml"));

        DialogPane bugLog = fxmlLoader.load();
        BugLog_Project_Dialog_Controller expandedProjectDetailsDialogController = fxmlLoader.getController();
