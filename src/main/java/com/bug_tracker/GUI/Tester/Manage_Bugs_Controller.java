...
public class Manage_Bugs_Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        workingProjectDetails.setAll(instance.getAllProjectsOfTester(Tester_MainScreen_Controller.getCurrentTesterObject()));
        tableviewProjectDetails.setItems(workingProjectDetails);
    }

    @FXML
    void perfromSeeAllBugsReportedByYou(ActionEvent event) throws IOException {
        ...
        fxmlLoader.setLocation(main.class.getResource("Tester_Manage_Bugs_Dialog_Show_Tester_login_Reported_Bugs.fxml"));

        DialogPane bugLog = fxmlLoader.load();
        Manage_Bugs_Dialog_Show_Tester_login_Reported_Bugs expandedProjectDetailsDialogController = fxmlLoader.getController();
        expandedProjectDetailsDialogController.setSelectedProject(selectedProject);

        Dialog<ButtonType> dialog = new Dialog<>();
        dialog.setDialogPane(bugLog);
        dialog.setTitle("Manage All the Bugs Reported By You");
