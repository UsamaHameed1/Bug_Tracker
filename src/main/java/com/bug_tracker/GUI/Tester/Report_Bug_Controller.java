...
public class Report_Bug_Controller implements Initializable {
    @FXML
    ...
    @FXML
    void performReportABug(ActionEvent event) throws IOException {
        ...
        fxmlLoader.setLocation(main.class.getResource("Tester_Report_Bug_Dialog_Controller.fxml"));

        DialogPane reportBugDialogWindow = fxmlLoader.load();
        Report_Bug_Dialog_Controller report_bug_dialog_controller = fxmlLoader.getController();
        report_bug_dialog_controller.setSelectedProject(selectedProject);
