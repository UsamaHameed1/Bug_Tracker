...
public class Developer_BugLog_Controller implements Initializable {
    @FXML
    ...
    void performSeeBugLogOfProject(ActionEvent event) throws IOException {
        ...
        fxmlLoader.setLocation(main.class.getResource("Developer_Bug_Log_Dialog.fxml"));

        DialogPane bugLog = fxmlLoader.load();
        Developer_BugLog_Dialog_Controller expandedProjectDetailsDialogController = fxmlLoader.getController();
